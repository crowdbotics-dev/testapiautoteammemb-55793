...
## Project Structure
    ...
    ├── testapiautoteammemb_55793  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_55793`
...
2. Clone this repo and `cd testapiautoteammemb_55793`
